  ...
  public: {
    Tables: {
      ...
      client_details: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_details_plan_id_fkey"
            columns: ["plan_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "client_details_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      client_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_notes_mentor_id_fkey"
            columns: ["mentor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_notes_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      student_stages: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_stages_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
